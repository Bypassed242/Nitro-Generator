...
def sendnitro(nitro,webhook_url):
    webhook = DiscordWebhook(url=webhook_url,username="Nitro-Gen", avatar_url="https://cdn.discordapp.com/attachments/1058477068532338698/1103994144466161714/86845555_1.jpg")
    embed = DiscordEmbed(title='Nitro-Gen', description='ðﾟﾎﾉCongratulation You Found A Nitroðﾟﾎﾉ', color='03b2f8')
    embed.set_footer(text='Made By BYPASSED#9122')
    embed.add_embed_field(name='✨Nitro✨', value='Click Claim To Caim You Nitro')
    embed.set_image(url="https://cdn.discordapp.com/attachments/1058477068532338698/1103994144466161714/86845555_1.jpg")
    webhook.add_embed(embed)
    webhook2 = DiscordWebhook(url=webhook_url,username="Nitro-Gen", avatar_url="https://cdn.discordapp.com/attachments/1058477068532338698/1103994144466161714/86845555_1.jpg", content=nitro)
    webhook.execute()
    webhook2.execute()

def BYPASSED():
    os.system("cls && title NITRO-GEN BY Bypassed#9310")
    generated = []
    valid = []
    invalid = []
    print(fire(f"""                                             ▐ ▄ ▪  ▄▄▄▄▄▄▄▄             ▄▄ • ▄▄▄ . ▐ ▄ 
                                            ...
                                            ██▐█▌▐█▌ ▐█▌·▐█•█▌▐█▌.▐▌    ▐█▄▪▐█▐█▄▄▌██▐█▌
                                            ▀▀ █▪▀▀▀ ▀▀▀ .▀  ▀ ▀█▄▀▪    ·▀▀▀▀  ▀▀▀ ▀▀ █▪
                                             https://github.com/bypassed242/Nitro-Generator
                                                       Made by BYPASSED#9122
"""))
            ...
            try:
                while True:
                    ...
                    if r.status_code == 200:
                        ...
                        generated.append(nitro)
                        ctypes.windll.kernel32.SetConsoleTitleW("NITRO-GEN BY Bypassed#9310 | Valid -> " + str(len(valid)) + " | Invalid -> " + str(len(invalid)))
            ...
            try:
                ...
                for x in range(amount):
                    ...
                    if r.status_code == 200:
                        ...
                        invalid.append(nitro)
                        generated.append(nitro)
                        ctypes.windll.kernel32.SetConsoleTitleW("NITRO-GEN BY BYPASSED#9122 | Valid -> " + str(len(valid)) + " | Invalid -> " + str(len(invalid)))
                print("")
                print("Results:")
                print("")
                print(f"{Fore.YELLOW}Generated {Fore.RESET}-> {len(generated)}")
